...
public class WorkHistoryController : DongNguyenController<WorkHistoryResource, CreateWorkHistoryResource, UpdateWorkHistoryResource, WorkHistory>
{
    ...
    [ProducesResponseType(typeof(BaseResult<WorkHistoryResource>), StatusCodes.Status201Created)]
    [ProducesResponseType(typeof(BaseResult<WorkHistoryResource>), StatusCodes.Status400BadRequest)]
    ...
    [HttpPut("{id:int}")]
    [Authorize(Roles = $"{Role.Admin}, {Role.EditorQTNS}, {Role.EditorQTDA}")]
    [ProducesResponseType(typeof(BaseResult<WorkHistoryResource>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(BaseResult<WorkHistoryResource>), StatusCodes.Status400BadRequest)]
