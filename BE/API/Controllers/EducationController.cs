...
public class EducationController : DongNguyenController<EducationResource, CreateEducationResource, UpdateEducationResource, Education>
{
    ...
    [ProducesResponseType(typeof(BaseResult<EducationResource>), StatusCodes.Status201Created)]
    [ProducesResponseType(typeof(BaseResult<EducationResource>), StatusCodes.Status400BadRequest)]
    ...
    [HttpPut("{id:int}")]
    [Authorize(Roles = $"{Role.Admin}, {Role.EditorQTNS}, {Role.EditorQTDA}")]
    [ProducesResponseType(typeof(BaseResult<EducationResource>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(BaseResult<EducationResource>), StatusCodes.Status400BadRequest)]
